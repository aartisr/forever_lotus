...
export default function AwariconFormulaPopover() {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      <div
        className={`awaricon-formula-popover absolute right-0 top-[calc(100%+0.6rem)] z-20 w-[min(21rem,80vw)] rounded-2xl border border-white/15 bg-[rgba(7,9,20,0.96)] p-4 shadow-[0_20px_55px_rgba(0,0,0,0.58)] transition-all duration-200 ${
